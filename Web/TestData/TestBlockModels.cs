        ...
        public static IList<BlockModel> BlockModels = new List<BlockModel>()
        {
            new BlockModel()
            {
                Links = new List<LinkModel>()
                {
                    ...
                    new LinkModel() {Description = "Some desc2", Link = "https://test.test", Title = "Title of link 2"},
                    new LinkModel() {Link = "https://test.test", Title = "Title of link 3"},
                    new LinkModel()
                    {
                        Description =
                    ...
                    new LinkModel()
                    {
                        ...
                        Link = "https://google.com", Title = "Title of link 5"
                    },
                    new LinkModel() {Link = "https://test.test", Title = "Title of link 6"},
                    new LinkModel() {Description = "Some desc7", Link = "https://test.test", Title = "Title of link 7"},
                    new LinkModel() {Description = "Some desc7", Link = "https://test.test", Title = "Title of link 7"}
                },
                Title = "Test title 1"
            },
            new BlockModel()
            {
                Links = new List<LinkModel>()
                {
                    new LinkModel() {Description = "Some desc1", Link = "https://test.test", Title = "Title of link 1"},
                    new LinkModel() {Description = "Some desc2", Link = "https://test.test", Title = "Title of link 2"},
                    new LinkModel() {Description = "Some desc3", Link = "https://test.test", Title = "Title of link 3"},
                    new LinkModel() {Description = "Some desc4", Link = "https://test.test", Title = "Title of link 4"},
                    new LinkModel() {Description = "Some desc5", Link = "https://test.test", Title = "Title of link 5"}
                },
                Title = "Test title 2"
            }
        };
